...
//    //[self.navigationItem setTitle:NSLocalizedString(@"Loading...", nil)];
//    cancelButtonItem.tintColor = color_purple;
    
    
//    UIButton* button = [UIButton buttonWithType:UIButtonTypeCustom];
//    [button setImage:[UIImage imageNamed:@"cam.png"] forState:UIControlStateNormal];
//    [button addTarget:self action:@selector(cameraAct:)forControlEvents:UIControlEventTouchUpInside];
//    [button sizeToFit];
